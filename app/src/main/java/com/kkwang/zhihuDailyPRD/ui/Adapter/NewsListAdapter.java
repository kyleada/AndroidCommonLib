package com.kkwang.zhihuDailyPRD.ui.Adapter;
...
import com.kkwang.zhihuDailyPRD.ui.Activity.NewsDetailActivity;
import com.kkwang.zhihuDailyPRD.view.TextSliderView;
...
public class NewsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            itemView = LayoutInflater.from(mContext).inflate(R.layout.zhprd_list_item_news, parent, false);
            return new ItemVH(itemView);
        } else if (viewType == TYPE_HEADER) {
            itemView = LayoutInflater.from(mContext).inflate(R.layout.zhprd_list_item_header, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemVH) {
            ...
            Picasso.with(mContext)
                    ...
                    .placeholder(R.drawable.zhprd_ic_placeholder)
