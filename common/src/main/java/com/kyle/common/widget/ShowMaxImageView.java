...
import com.kyle.common.utils.ViewUtils;
...
public class ShowMaxImageView extends ImageView {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mHeight != 0) {
			...
			if (resultHeight >= ViewUtils.getScreenHeight((Activity) getContext())) {
				resultHeight = ViewUtils.getScreenHeight((Activity) getContext()) / 3;
			}
