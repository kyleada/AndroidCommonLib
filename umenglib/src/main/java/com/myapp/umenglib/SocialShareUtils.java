...
public class SocialShareUtils {
    ...
    private static UMSocialService mController = UMServiceFactory
            .getUMSocialService(ShareConfigConstants.DESCRIPTOR);
    ...
    private static void addWXPlatform(Context context) {
        ...
        String appId = ShareConfigConstants.WEXIN_APPID;
        String appSecret = ShareConfigConstants.WEXIN_APPSECRET;
        // 添加微信平台
    ...
    private static void addQQQZonePlatform(Context context) {
        String appId = ShareConfigConstants.QQZONE_APPID;
        String appKey = ShareConfigConstants.QQZONE_APPKEY;
    ...
    public static void setShareContent(Context context, ShareDomain shareDomain) {
        ...
        QZoneSsoHandler qZoneSsoHandler = new QZoneSsoHandler(
                (Activity) context, ShareConfigConstants.QQZONE_APPID,
                ShareConfigConstants.QQZONE_APPKEY);
        qZoneSsoHandler.addToSocialSDK();
